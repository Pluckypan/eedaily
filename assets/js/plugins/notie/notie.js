...
var notie = function() {
	...
	function showhtml(title, yesText, noText, yesCallback, noCallback) {
		confirmInner.style.padding = '0px';
		confirmText.style.color = 'inherit';
		confirmOuter.style.textAlign = 'inherit';
		confirmOuter.style.fontSize = 'inherit';
		confirmYes.style.textAlign = 'center';
		confirmYes.style.fontSize = '18px';
		confirmNo.style.textAlign = 'center';
		confirmNo.style.fontSize = '18px';
